...
namespace ProcessoEletronicoService.WebAPI.Rascunhos.Processo
{
    ...
    public class EmailInteressadoPessoaJuridicaController : BaseController
    {
        ...
        /// <summary>
        /// Lista de emails do interessado pessoa jurídica do rascunho de processos
        /// </summary>
        ...
        /// <returns>Lista de emails de interessados pessoa jurídica do rascunho de processos</returns>
        /// <response code="200">Lista de emails do interessado pessoa jurídica do rascunho de processos</response>
        ...
        /// <summary>
        /// Email do interessado pessoa jurídica do rascunho de processos
        /// </summary>
        /// <param name="idRascunhoProcesso">Identificador do rascunho de processos</param>
        /// <param name="idInteressado">Identificador do interessado pessoa jurídica</param>
        /// <param name="id">Identificador do email</param>
        /// <returns>Email do interessado pessoa jurídica do rascunho de processos</returns>
        /// <response code="200">Email do interessado pessoa jurídica do rascunho de processos</response>
        /// <response code="404">Recurso não encontrado</response>
        /// <response code="500">Falha inesperada</response>
        ...
        /// <summary>
        /// Inserção de email ao interessado pessoa jurídica do rascunho de processos
        /// </summary>
        /// <param name="idRascunhoProcesso">Identificador do rascunho de processos</param>
        /// <param name="idInteressado">Identificador do interessado pessoa jurídica</param>
        /// <param name="postEmailDto">Informações do email a ser inserido</param>
        /// <returns>Email recém inserido</returns>
        /// <response code="201">Email de interessados pessoa jurídica do rascunho de processos</response>
        /// <response code="404">Recurso não encontrado</response>
        ...
        /// <summary>
        /// Alteração de email do interessado pessoa jurídica do rascunho de processos
        /// </summary>
        /// <param name="idRascunhoProcesso">Identificador do rascunho de processos</param>
        ...
        /// <summary>
        /// Exclusão de email do interessado pessoa jurídica do rascunho de processos
        /// </summary>
        /// <param name="idRascunhoProcesso">Identificador do rascunho de processos</param>
        /// <param name="idInteressado">Identificador do interessado pessoa jurídica</param>
        /// <param name="id">Identificador do email</param>
