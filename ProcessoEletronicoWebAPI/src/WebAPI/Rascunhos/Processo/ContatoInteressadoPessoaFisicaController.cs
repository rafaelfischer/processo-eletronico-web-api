...
namespace ProcessoEletronicoService.WebAPI.Rascunhos.Processo
{
    ...
    public class ContatoInteressadoPessoaFisicaController : BaseController
    {
        ...
        /// <response code="200">Lista de contatos do interessado pessoa física do rascunho de processos</response>
        ...
        /// <response code="201">Contatos recém inserido do interessado pessoa física do rascunho de processos</response>
        /// <response code="404">Recurso não encontrado</response>
